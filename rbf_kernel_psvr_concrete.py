...
def rbf_kernel(gamma,C,X_tr,y_tr,X_te,y_te):
    list1=[]
    ...
    K_rbf=sklearn.metrics.pairwise.rbf_kernel(X_tr, Y=X_tr, gamma=gamma)
         #print(K_lin)
    ...
    K=sklearn.metrics.pairwise.rbf_kernel(X_tr, Y=X_te, gamma=gamma)
    y_pred=[]
